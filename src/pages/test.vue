      ...
      <div class="label_container" v-for="(item, index) in tableData" :key='index'>
        ...
        <div class="image_preview">
          <div class="image" v-for="(content, index2) in item.contents" :key="index2"style="position:relative">
            ...
            <el-button type="info"  size="mini" round @click="deleteImage(item)" style="position:relative;left:-25px;top:-90px;">X</el-button>
          </div>
        </div>
        ...
        tableData: [
          {
            label: 'test',
            contents:[
              require("C:\\Users\\lenovo\\Desktop\\models\\catVsMaibao\\cat\\cat1.jpg"),
              require("C:\\Users\\lenovo\\Desktop\\models\\catVsMaibao\\cat\\cat2.jpg"),
              require("C:\\Users\\lenovo\\Desktop\\models\\catVsMaibao\\cat\\cat2.jpg"),
              require("C:\\Users\\lenovo\\Desktop\\models\\catVsMaibao\\cat\\cat2.jpg"),
              require("C:\\Users\\lenovo\\Desktop\\models\\catVsMaibao\\cat\\cat2.jpg")
            ]
