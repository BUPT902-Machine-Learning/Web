...
export const apiUrl = {
  ...
  imageIfTrain: "/api/image/imageIfTrain/",                               //获取模型训练状态
  editImgModel: "/api/image/editImgModel/",                             //教师获取已创建模型的原始信息（标签、样本以及图片文件）
  reTrainImgModel: "/api/image/reTrainImgModel/",                       //重新训练已有模型（做数据或者权限的修改后）
  publishImgModel: "/api/image/publishImgModel/",                       //教师发布合作模型
  editStuImgModel: "/api/image/editStuImgModel/",                       //学生获取已创建模型的原始信息（标签、样本以及图片文件）
